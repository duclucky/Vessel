...
(() => {
  ...
  // client-src/vessel-official-shelby.jsx
  init_process();
  init_buffer();

  // client-src/official-shelby/bridge.jsx
  init_process();
  init_buffer();
  var import_react = __toESM(require_react(), 1);
  var import_client = __toESM(require_client(), 1);
  var defaultBridgeState = Object.freeze({
    ready: false,
    session: null,
    lastError: null
  });
  ...
  function OfficialShelbyBridge() {
    const [state, setState] = (0, import_react.useState)(defaultBridgeState);
  ...
  function mountOfficialShelbyBridge(target = document.createElement("div")) {
    ...
    root.render(/* @__PURE__ */ import_react.default.createElement(OfficialShelbyBridge, null));
    return root;
  }
